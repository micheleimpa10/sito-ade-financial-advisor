  ...
  const SHOP_PRODUCTS = [
    {
      ...
      badge: "NEW",
      cover: "/manus-storage/cover_01_moving_guide_d8095922.png",
    ...
    },
    {
      ...
      badge: null,
      cover: "/manus-storage/cover_02_agenda_couples_0dd5af53.png",
    ...
    },
    {
      ...
      badge: null,
      cover: "/manus-storage/cover_03_agenda_single_0291e04f.png",
    ...
    },
    {
      ...
      cover: "/manus-storage/cover_04_budget_personal_49bbe804.png",
    ...
    },
    {
      ...
      badge: null,
      cover: "/manus-storage/cover_05_budget_family_9f868d9e.png",
          ...
          <Reveal delay={200} className="mt-16">
            ...
            <div className="grid grid-cols-3 gap-4 mb-4">
              <div className="col-span-2 overflow-hidden rounded-2xl shadow-md border border-white/10 group">
                <img src={PHOTO_SOFA_CONSULT} alt="Adelaide Manta consulting a client" className="w-full h-72 object-cover object-center group-hover:scale-105 transition-transform duration-700" />
              </div>
              <div className="overflow-hidden rounded-2xl shadow-md border border-white/10 group">
                <img src={PHOTO_REDSOFA_CONSULT} alt="Adelaide Manta in a consultation" className="w-full h-72 object-cover object-top group-hover:scale-105 transition-transform duration-700" />
              </div>
            </div>
            {/* Row B: 3 equal */}
            <div className="grid grid-cols-3 gap-4 mb-4">
              <div className="overflow-hidden rounded-2xl shadow-md border border-white/10 group">
                <img src={PHOTO_WORKING_DESK} alt="Adelaide Manta at her desk" className="w-full h-60 object-cover object-top group-hover:scale-105 transition-transform duration-700" />
              </div>
              <div className="overflow-hidden rounded-2xl shadow-md border border-white/10 group">
                <img src={CONSULTATION_ALPS} alt="Adelaide Manta consulting in the Alps" className="w-full h-60 object-cover object-center group-hover:scale-105 transition-transform duration-700" />
              </div>
              <div className="overflow-hidden rounded-2xl shadow-md border border-white/10 group">
                <img src={SERVICES_BG} alt="Adelaide Manta with a client" className="w-full h-60 object-cover object-top group-hover:scale-105 transition-transform duration-700" />
              </div>
            </div>
            {/* Row C: portrait (1/3) + wide (2/3) */}
            <div className="grid grid-cols-3 gap-4 mb-4">
              <div className="overflow-hidden rounded-2xl shadow-md border border-white/10 group">
                <img src={PHOTO_ZURICH_TERRACE} alt="Adelaide Manta in Zurich" className="w-full h-64 object-cover object-top group-hover:scale-105 transition-transform duration-700" />
              </div>
              <div className="col-span-2 overflow-hidden rounded-2xl shadow-md border border-white/10 group">
                <img src={PHOTO_CAFE_MEETING} alt="Adelaide Manta with a client at a café" className="w-full h-64 object-cover object-center group-hover:scale-105 transition-transform duration-700" />
              </div>
            </div>
            {/* Row D: 3 equal */}
            <div className="grid grid-cols-3 gap-4">
              <div className="overflow-hidden rounded-2xl shadow-md border border-white/10 group">
                <img src={PHOTO_OUTDOOR_MEETING} alt="Adelaide Manta meeting a client outdoors" className="w-full h-60 object-cover object-center group-hover:scale-105 transition-transform duration-700" />
              </div>
              <div className="overflow-hidden rounded-2xl shadow-md border border-white/10 group">
                <img src={PHOTO_PHONE_CALL} alt="Adelaide Manta on a call" className="w-full h-60 object-cover object-top group-hover:scale-105 transition-transform duration-700" />
              </div>
              <div className="overflow-hidden rounded-2xl shadow-md border border-white/10 group">
                <img src={HERO_BG} alt="Adelaide Manta at work" className="w-full h-60 object-cover object-top group-hover:scale-105 transition-transform duration-700" />
              </div>
            </div>
          </Reveal>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-[#1a2744] rounded-2xl p-7 relative overflow-hidden flex flex-col h-full">
                ...
                <div className="flex items-start gap-4 mb-5">
                  <div className="hidden sm:block flex-shrink-0 w-24 h-16 rounded-lg overflow-hidden shadow-md">
                    <img src="/manus-storage/cover_06_single_bundle_d9635c21.png" alt="Single Money Bundle" className="w-full h-full object-cover" />
                  </div>
                  <div>
            ...
            <Reveal>
              <div className="bg-[#1a2744] rounded-2xl p-7 relative overflow-hidden flex flex-col h-full">
                ...
                <div className="flex items-start gap-4 mb-5">
                  <div className="hidden sm:block flex-shrink-0 w-24 h-16 rounded-lg overflow-hidden shadow-md">
                    <img src="/manus-storage/cover_07_family_bundle_13fb04e9.png" alt="Family Money Bundle" className="w-full h-full object-cover" />
                  </div>
                  <div>
                    <div className="inline-flex items-center gap-1.5 bg-[#c9a84c] text-[#1a2744] text-[9px] font-black uppercase tracking-widest px-3 py-1 rounded-full mb-2">
                      <Sparkles className="h-2.5 w-2.5" />
