...
export const PRODUCTS: Record<string, Product> = {
  ...
  "moving-guide": {
    ...
    downloadPath: "/manus-storage/Moving_to_Switzerland_Complete_Guide_5b39cb12.zip",
  ...
  "budget-manager-personal": {
    ...
    downloadPath: "/manus-storage/04_Personal_LIVE_v6_7d544111.zip",
  ...
  "budget-manager-family": {
    ...
    downloadPath: "/manus-storage/05_Family_LIVE_v6_b9c6671e.zip",
  ...
  "single-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "personal",
    downloadPath: "/manus-storage/06_Bundle_LIVE_v6_5f7408ab.zip",
  ...
  "family-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "family",
    downloadPath: "/manus-storage/07_Bundle_LIVE_v6_31114008.zip",
