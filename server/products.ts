...
export const PRODUCTS: Record<string, Product> = {
  ...
  "budget-manager-personal": {
    ...
    downloadPath: "/manus-storage/BudgetManager_Personal_19efdc9e.zip",
  ...
  "budget-manager-family": {
    ...
    downloadPath: "/manus-storage/BudgetManager_Family_08b93e09.zip",
  ...
  "single-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "personal",
    downloadPath: "/manus-storage/Single_Bundle_1dedacf8.zip",
  ...
  "family-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "family",
    downloadPath: "/manus-storage/Family_Bundle_3b6238f1.zip",
