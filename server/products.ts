...
export const PRODUCTS: Record<string, Product> = {
  ...
  "budget-manager-personal": {
    ...
    downloadPath: "/manus-storage/BudgetManager_Personal_0c185e7f.zip",
  ...
  "budget-manager-family": {
    ...
    downloadPath: "/manus-storage/BudgetManager_Family_9e286f62.zip",
  ...
  "single-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "personal",
    downloadPath: "/manus-storage/Single_Bundle_409427e3.zip",
  ...
  "family-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "family",
    downloadPath: "/manus-storage/Family_Bundle_78f9326f.zip",
