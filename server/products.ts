...
export const PRODUCTS: Record<string, Product> = {
  ...
  "budget-manager-personal": {
    ...
    downloadPath: "/manus-storage/04_Personal_LIVE_v4_5db7626b.zip",
  ...
  "budget-manager-family": {
    ...
    downloadPath: "/manus-storage/05_Family_LIVE_v4_6e506a5e.zip",
  ...
  "single-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "personal",
    downloadPath: "/manus-storage/06_Bundle_LIVE_v4_7e342914.zip",
  ...
  "family-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "family",
    downloadPath: "/manus-storage/07_Bundle_LIVE_v4_6b7ebda5.zip",
