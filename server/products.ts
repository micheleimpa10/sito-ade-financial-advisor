...
export const PRODUCTS: Record<string, Product> = {
  ...
  "moving-guide": {
    ...
    downloadPath: "/manus-storage/01_Moving_to_Switzerland_Complete_Guide_2026_ea576a78.zip",
  ...
  "financial-agenda-couples": {
    ...
    requiresLicenseKey: false,
    downloadPath: "/manus-storage/02_Financial_Agenda_Couples_3f80b1c5.zip",
  ...
  "financial-agenda-single": {
    ...
    requiresLicenseKey: false,
    downloadPath: "/manus-storage/03_Financial_Agenda_Single_b7235d06.zip",
  ...
  "budget-manager-personal": {
    ...
    downloadPath: "/manus-storage/04_Personal_LIVE_v2_2537098d.zip",
  ...
  "budget-manager-family": {
    ...
    downloadPath: "/manus-storage/05_Family_LIVE_v2_a629c260.zip",
  ...
  "single-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "personal",
    downloadPath: "/manus-storage/06_Bundle_LIVE_v2_3ff662fe.zip",
  ...
  "family-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "family",
    downloadPath: "/manus-storage/07_Bundle_LIVE_v2_e6f29ec2.zip",
