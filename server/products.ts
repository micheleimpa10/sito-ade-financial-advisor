...
export const PRODUCTS: Record<string, Product> = {
  ...
  "budget-manager-personal": {
    ...
    downloadPath: "/manus-storage/04_BudgetManager_Personal_4ee14851.zip",
  ...
  "budget-manager-family": {
    ...
    downloadPath: "/manus-storage/05_BudgetManager_Family_f119919f.zip",
  ...
  "single-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "personal",
    downloadPath: "/manus-storage/06_Single_Bundle_c0270a1c.zip",
  ...
  "family-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "family",
    downloadPath: "/manus-storage/07_Family_Bundle_6c1ac65d.zip",
