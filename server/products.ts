...
export const PRODUCTS: Record<string, Product> = {
  ...
  "budget-manager-personal": {
    ...
    downloadPath: "/manus-storage/04_BudgetManager_Personal_fixed_3250ac12.zip",
  ...
  "budget-manager-family": {
    ...
    downloadPath: "/manus-storage/05_BudgetManager_Family_fixed_cddb0991.zip",
  ...
  "single-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "personal",
    downloadPath: "/manus-storage/06_Single_Bundle_fixed_0b1f9e13.zip",
  ...
  "family-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "family",
    downloadPath: "/manus-storage/07_Family_Bundle_fixed_5ed7afc7.zip",
