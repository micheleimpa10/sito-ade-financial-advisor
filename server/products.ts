...
export const PRODUCTS: Record<string, Product> = {
  ...
  "budget-manager-personal": {
    ...
    downloadPath: "/manus-storage/04_Personal_LIVE_bb2e2cda.zip",
  ...
  "budget-manager-family": {
    ...
    downloadPath: "/manus-storage/05_Family_LIVE_2fa43016.zip",
  ...
  "single-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "personal",
    downloadPath: "/manus-storage/06_Bundle_LIVE_cb7ed1fb.zip",
  ...
  "family-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "family",
    downloadPath: "/manus-storage/07_Bundle_LIVE_5abe0762.zip",
