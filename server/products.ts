...
export const PRODUCTS: Record<string, Product> = {
  ...
  "budget-manager-personal": {
    ...
    downloadPath: "/manus-storage/04_BudgetManager_Personal_3ccbd2ee.zip",
  ...
  "budget-manager-family": {
    ...
    downloadPath: "/manus-storage/05_BudgetManager_Family_8555cf1e.zip",
  ...
  "single-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "personal",
    downloadPath: "/manus-storage/06_Single_Bundle_2681a9a0.zip",
  ...
  "family-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "family",
    downloadPath: "/manus-storage/07_Family_Bundle_a56a0a3c.zip",
