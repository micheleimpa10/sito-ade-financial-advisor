...
export const PRODUCTS: Record<string, Product> = {
  ...
  "budget-manager-personal": {
    ...
    downloadPath: "/manus-storage/BudgetManager_Personal_6852f03d.zip",
  ...
  "budget-manager-family": {
    ...
    downloadPath: "/manus-storage/BudgetManager_Family_868c666e.zip",
  ...
  "single-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "personal",
    downloadPath: "/manus-storage/Single_Bundle_06be9cd6.zip",
  ...
  "family-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "family",
    downloadPath: "/manus-storage/Family_Bundle_a0a7a4c4.zip",
