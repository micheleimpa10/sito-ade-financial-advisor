...
export const PRODUCTS: Record<string, Product> = {
  ...
  "moving-guide": {
    ...
    downloadPath: "/manus-storage/01_Moving_to_Switzerland_12730f9d.zip",
  ...
  "financial-agenda-couples": {
    ...
    requiresLicenseKey: false,
    downloadPath: "/manus-storage/02_Financial_Agenda_Couples_6b738084.zip",
  ...
  "financial-agenda-single": {
    ...
    requiresLicenseKey: false,
    downloadPath: "/manus-storage/03_Financial_Agenda_Single_db44504b.zip",
  ...
  "budget-manager-personal": {
    ...
    downloadPath: "/manus-storage/04_BudgetManager_Personal_v2_e4c7fdce.zip",
  ...
  "budget-manager-family": {
    ...
    downloadPath: "/manus-storage/05_BudgetManager_Family_v2_a065d0d1.zip",
  ...
  "single-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "personal",
    downloadPath: "/manus-storage/06_Single_Bundle_v2_4834cc20.zip",
  ...
  "family-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "family",
    downloadPath: "/manus-storage/07_Family_Bundle_v2_3830bf65.zip",
