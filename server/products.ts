...
export const PRODUCTS: Record<string, Product> = {
  ...
  "budget-manager-personal": {
    ...
    downloadPath: "/manus-storage/04_Personal_LIVE_v5_9469a341.zip",
  ...
  "budget-manager-family": {
    ...
    downloadPath: "/manus-storage/05_Family_LIVE_v5_24c1826e.zip",
  ...
  "single-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "personal",
    downloadPath: "/manus-storage/06_Bundle_LIVE_v5_7c0a3dc6.zip",
  ...
  "family-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "family",
    downloadPath: "/manus-storage/07_Bundle_LIVE_v5_f58d890c.zip",
