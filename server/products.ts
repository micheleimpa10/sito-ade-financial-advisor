...
export const PRODUCTS: Record<string, Product> = {
  ...
  "budget-manager-personal": {
    ...
    downloadPath: "/manus-storage/04_BudgetManager_Personal_5c0c7588.zip",
  ...
  "budget-manager-family": {
    ...
    downloadPath: "/manus-storage/05_BudgetManager_Family_13219ee0.zip",
  ...
  "single-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "personal",
    downloadPath: "/manus-storage/06_Single_Bundle_7ae2122c.zip",
  ...
  "family-bundle": {
    ...
    requiresLicenseKey: true,
    licenseKeyTier: "family",
    downloadPath: "/manus-storage/07_Family_Bundle_4a491cd9.zip",
